...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">Update Profile</h4>
        </div>
        <div class="card-body">
         <?php
                ...
                if ($gotResults && mysqli_num_rows($gotResults) > 0) {
                    while ($row = mysqli_fetch_array($gotResults)) {
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="updateUsername"  id="updateUsername" maxlength="20"  class="form-control" value="<?php echo $row['name']; ?>" placeholder="Enter Name" required>
        ...
        if (updateUsernameInput.length > 20) {
            ...
            usernameError.textContent = '';
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="useremail" id="useremail" class="form-control" value="<?php echo $row['email']; ?>" maxlength="20" required placeholder="Enter email">
        ...
        if (emailInput.length > 20) {
            ...
            emailError.textContent = '';
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="usercontact"  class="form-control" value="<?php echo $row['contact']; ?>" maxlength="11" placeholder="Enter Contact Number" required>
            ...
            if (!regex.test(contact)) {
                ...
                errorSpan.textContent = "";
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="userpassword" maxlength="11" required class="form-control" value="<?php echo $row['password']; ?>" placeholder="Enter password">
                        </div>
                        <div class="form-group"> 
                        ...
                        <button type="submit" name="updateadminprofile" class="btn btn-primary">Update</button>
                    <?php
                    }
                }
                ?>
